...
const SOLIDITY_IMAGE_ID_PATH: &str = "../contracts/src/v2-zk/ImageID.sol";
const SOLIDITY_ELF_PATH: &str = "../contracts/test/v2-zk/Elf.sol";
...
fn main() {
    ...
    let guests = embed_methods_with_options(HashMap::from([("nft-ownership", guest_options)]));
